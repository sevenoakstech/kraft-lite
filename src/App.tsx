...
import { ErrorComponent, notificationProvider, ThemedLayoutV2, RefineSnackbarProvider } from "@refinedev/mui";
...
import { CourierList, CourierShow, CourierCreate, CourierEdit } from "./pages/couriers";
...
const App: React.FC = () => {
	...
	const i18nProvider = {
		translate: (key: string, params: object) => t(key as any, params as any),
